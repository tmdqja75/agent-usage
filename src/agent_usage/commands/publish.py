...
from agent_usage.publish.git import PublishResult, clone_or_open, publish_device_partition
...
def publish(
    *,
    ...
    value), so monkeypatching ``agent_usage.commands.publish.check_gh_auth``
